          ...
          <>
            ...
            <div className="mb-8 space-y-4">
              ...
              <button
                ...
                className="w-full flex items-center justify-center space-x-3 px-6 py-3 bg-purple-600 hover:bg-purple-700 disabled:bg-slate-700 disabled:cursor-not-allowed text-white rounded-lg font-semibold transition shadow-lg shadow-purple-500/20"
              >
